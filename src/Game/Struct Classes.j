library StructGameClasses requires Asl, StructGameCharacter
	...
	struct Classes
		...
		private static method initNecromancer takes nothing returns nothing
			...
			call thistype.m_necromancer.addDescriptionLine(tre("jedoch verehren sie andere Götter als der Großteil der Menschen.", "however they worship other gods than the majority of people."))
			...
			call thistype.m_necromancer.addDescriptionLine(tre("Mit ihrer Hilfe fügen sie ihren Opfern langsam Schmerzen zu und beschwören Kreaturen", "With its help they cause their victims slowly pain and summon creatures"))
		...
		private static method initElementalMage takes nothing returns nothing
			...
			call thistype.m_elementalMage.addDescriptionLine(tre("Elementarmagier sind trotz ihres häufig gebrechlich anmutenden Äußeren erbarmungslose Widersacher,", "Elementalists are merciless adversaries despite their often frail-looking outward appearance"))
		...
		private static method initWizard takes nothing returns nothing
			...
			call thistype.m_wizard.addDescriptionLine(tre("Der Zauberer kontrolliert im Gegensatz zum Elementarmagier", "The wizard does not control unlike the Elementalist"))
