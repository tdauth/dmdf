library StructGameGame requires Asl, StructGameCharacter, StructGameItemTypes, LibraryGameLanguage
	...
	struct GameExperience
		...
		private static constant real xpHandicap = 0.20 // this XP factor is used to reduce the actual gained experience such as in the Bonus Campaign. We want to prevent the characters from leveling too fast. In the Bonus Campaign it is 10 % and on difficulty hard it is even 7 %.
...
static if (DEBUG_MODE) then
			...
			call AInventory.init('I001', 'I000', 'A015', false, tre("Ausrüstungsfach wird bereits von einem anderen Gegenstand belegt.", "Equipment slot is already used by another item."), null, tre("Rucksack ist voll.", "Backpack is full."), tr("%1% im Rucksack verstaut"), tre("Gegenstand konnte nicht verschoben werden.", "Item cannot be moved"), tre("Die Seitengegenstände können nicht abgelegt werden.", "The page items cannot be dropped."), tre("Die Seitengegenstände können nicht verschoben werden.", "The page items cannot be moved."), tre("Der Gegendstand gehört einem anderen Spieler.", "This item belongs to another player."), tr("Vorherige Seite ist bereits voll."), tr("Nächste Seite ist bereits voll."))
