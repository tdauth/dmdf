library StructMapMapMapData requires Asl, StructGameGame
	...
	struct MapData
		...
		public static method init takes nothing returns nothing
			...
			call ZoneData.create(thistype.m_zoneDornheim, "", tr("Dornheim"), tr("Dornheim ist ein kleines Dorf im Königreich der Menschen."))
			set thistype.m_zoneTalras = Zone.create("TL", gg_rct_zone_talras)
			call ZoneData.create(thistype.m_zoneTalras, "", tr("Talras"), tr("Talras ist eine Burg im Grenzland des Königreichs der Menschen."))
			set thistype.m_zoneGardonar = Zone.create("GA", gg_rct_zone_gardonar)
			call ZoneData.create(thistype.m_zoneGardonar, "Gardonar.tga", tr("Gardonar"), tr("Gardonar ist der Fürst der Dämonen."))
			set thistype.m_zoneGardonarsHell = Zone.create("GH", gg_rct_zone_gardonars_hell)
			call ZoneData.create(thistype.m_zoneGardonarsHell, "Gardonar.tga", tr("Gardonars Hölle"), tr("Gardonars Hölle ist voll von Dämonen."))
			set thistype.m_zoneDeranorsSwamp = Zone.create("DS", gg_rct_zone_deranors_swamp)
			call ZoneData.create(thistype.m_zoneDeranorsSwamp, "", tr("Deranors Todessumpf"), tr("Deranor der Schreckliche herrscht über die Untoten in seinem Sumpf."))
			set thistype.m_zoneHolzbruck = Zone.create("HB", gg_rct_zone_holzbruck)
			call ZoneData.create(thistype.m_zoneHolzbruck, "", tr("Holzbruck"), tr("Holzbruck ist eine reiche Handelsstadt im Königreich der Menschen."))
			set thistype.m_zoneHolzbrucksUnderworld = Zone.create("HU", gg_rct_zone_holzbrucks_underworld)
			call ZoneData.create(thistype.m_zoneHolzbrucksUnderworld, "Gardonar.tga", tr("Holzbrucks Unterwelt"), tr("In der Unterwelt von Holzbruck sammeln sich mächtige Kreaturen."))
			set thistype.m_zoneTheNorth = Zone.create("TN", gg_rct_zone_the_north)
			call ZoneData.create(thistype.m_zoneTheNorth, "", tr("Der Norden"), tr("Im eisigen Norden leben die Nordmänner und Orks, die sich gegenseitig bekämpfen."))
