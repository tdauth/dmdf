...
library StructSpellsSpellShooter requires Asl, StructGameClasses, StructGameSpell
	...
	struct SpellShooter extends Spell
		...
		public static method create takes Character character returns thistype
			local thistype this = thistype.createWithoutTriggers(character, Classes.ranger(), Spell.spellTypeDefault, thistype.maxLevel, thistype.abilityId, thistype.favouriteAbilityId)
