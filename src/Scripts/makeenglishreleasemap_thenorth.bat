...
"E:\wc3tools\5.0wc3mapoptimizer\VXJWTSOPT.exe" "E:\Projekte\dmdf\maps\releases\TheNorth\TheNorth%VERSION%.w3x" --do  "E:\Projekte\dmdf\maps\releases\en\TheNorth%VERSION%.w3x" --checkscriptstuff --exit
