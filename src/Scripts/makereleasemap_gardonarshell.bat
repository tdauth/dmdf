...
del "E:\Projekte\dmdf\maps\releases\GardonarsHell\GH.w3x"
cp "E:\Projekte\dmdf\maps\Karte 2.1 - Gardonars Unterwelt.w3x" "E:\Projekte\dmdf\maps\releases\GardonarsHell\GH.w3x"
