...
SET TARGET_CAMPAIGN_MAP="F:\Projekte\dmdf\archive_en\Maps\TPoF\Campaign%CAMPAIGN_VERSION%\GH.w3x"
del "%TARGET_CAMPAIGN_MAP%"
copy "F:\Projekte\dmdf\maps\releases\en\GardonarsHell%VERSION%.w3x" "%TARGET_CAMPAIGN_MAP%"