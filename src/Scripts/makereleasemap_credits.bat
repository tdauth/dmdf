...
"E:\wc3tools\5.0wc3mapoptimizer\VXJWTSOPT.exe" --tweak "E:\Projekte\dmdf\src\Scripts\tweaks.vxtweak" "E:\Projekte\dmdf\maps\Credits.w3x" --do "E:\Projekte\dmdf\maps\releases\de\Credits%VERSION%.w3x" --checkscriptstuff --exit