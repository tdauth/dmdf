...
"E:\wc3tools\5.0wc3mapoptimizer\VXJWTSOPT.exe" "E:\Projekte\dmdf\maps\releases\Dornheim\Dornheim%VERSION%.w3x" --do  "E:\Projekte\dmdf\maps\releases\en\Dornheim%VERSION%.w3x" --checkscriptstuff --exit
