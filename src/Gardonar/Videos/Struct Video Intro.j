library StructMapVideosVideoIntro requires Asl, StructGameGame
	...
	struct VideoIntro extends AVideo
		...
		public stub method onPlayAction takes nothing returns nothing
			...
			call TransmissionFromUnitWithName(this.unitActor(this.m_actorDragonSlayer), tre("Drachentöterin", "Dragon Slayer"), tr("Wenn ihr dem Weg weiter folgt, kommt ihr zu einem Tor, das von Dämonen bewacht wird. Weiß der Teufel wo wir hier gelandet sind. Ihr solltet erst einmal die Gegend erkunden."), null)
