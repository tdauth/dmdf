...
library StructMapVideosVideoTheFirstCombat requires Asl, StructGameGame
	...
	struct VideoTheFirstCombat extends AVideo
		...
		public stub method onInitAction takes nothing returns nothing
			...
			//orc leader, 6
			set createdUnit = CreateUnitAtRect(Game.hostilePlayer(), 'n01F', gg_rct_video_the_first_combat_orc_leader, 107.04)
			...
			set createdUnit = CreateUnitAtRect(Game.hostilePlayer(), 'n01A', gg_rct_video_the_first_combat_orc_0, 56.55)
			call GroupAddUnit(this.m_firstEnemyGroup, createdUnit)
			call AVideo.saveUnitActor(createdUnit)
			set createdUnit = null
			call GroupAddUnit(this.m_secondActorGroup, AVideo.unitActor(7))
			//orc 1, 8 - Hexer
			set createdUnit = CreateUnitAtRect(Game.hostilePlayer(), 'n018', gg_rct_video_the_first_combat_orc_1, 224.73)
			call GroupAddUnit(this.m_firstEnemyGroup, createdUnit)
			call AVideo.saveUnitActor(createdUnit)
			set createdUnit = null
			call GroupAddUnit(this.m_secondActorGroup, AVideo.unitActor(8))
			//orc 2, 9 - Krieger
			set createdUnit = CreateUnitAtRect(Game.hostilePlayer(), 'n019', gg_rct_video_the_first_combat_orc_2, 139.98)
			call GroupAddUnit(this.m_firstEnemyGroup, createdUnit)
			call AVideo.saveUnitActor(createdUnit)
			set createdUnit = null
			call GroupAddUnit(this.m_secondActorGroup, AVideo.unitActor(9))
			//orc 3, 10 - Krieger
			set createdUnit = CreateUnitAtRect(Game.hostilePlayer(), 'n019', gg_rct_video_the_first_combat_orc_3, 25.90)
			call GroupAddUnit(this.m_firstEnemyGroup, createdUnit)
			call AVideo.saveUnitActor(createdUnit)
			set createdUnit = null
			call GroupAddUnit(this.m_secondActorGroup, AVideo.unitActor(10))
			//orc 4, 11 - Armbrustschütze
			set createdUnit = CreateUnitAtRect(Game.hostilePlayer(), 'n01A', gg_rct_video_the_first_combat_orc_4, 125.81)
			call GroupAddUnit(this.m_firstEnemyGroup, createdUnit)
			call AVideo.saveUnitActor(createdUnit)
			set createdUnit = null
			call GroupAddUnit(this.m_secondActorGroup, AVideo.unitActor(11))
			//orc 5, 12 - Berserkerin
			set createdUnit = CreateUnitAtRect(Game.hostilePlayer(), 'n01G', gg_rct_video_the_first_combat_orc_5, 331.54)
			call GroupAddUnit(this.m_firstEnemyGroup, createdUnit)
			call AVideo.saveUnitActor(createdUnit)
			set createdUnit = null
			call GroupAddUnit(this.m_secondActorGroup, AVideo.unitActor(12))
			//orc 6, 13 - Armbrustschütze
			set createdUnit = CreateUnitAtRect(Game.hostilePlayer(), 'n01A', gg_rct_video_the_first_combat_orc_6, 297.26)
			call GroupAddUnit(this.m_firstEnemyGroup, createdUnit)
			call AVideo.saveUnitActor(createdUnit)
			set createdUnit = null
			call GroupAddUnit(this.m_secondActorGroup, AVideo.unitActor(13))
			//orc 7, 14 - Krieger
			set createdUnit = CreateUnitAtRect(Game.hostilePlayer(), 'n019', gg_rct_video_the_first_combat_orc_7, 267.69)
			call GroupAddUnit(this.m_firstEnemyGroup, createdUnit)
			call AVideo.saveUnitActor(createdUnit)
			set createdUnit = null
			call GroupAddUnit(this.m_secondActorGroup, AVideo.unitActor(14))
			//dark elf 0, 15 - Waldgeist (männlich)
			set createdUnit = CreateUnitAtRect(Game.hostilePlayer(), 'n01W', gg_rct_video_the_first_combat_dark_elf_0, 316.95)
			call GroupAddUnit(this.m_firstEnemyGroup, createdUnit)
			call AVideo.saveUnitActor(createdUnit)
			set createdUnit = null
			call GroupAddUnit(this.m_secondActorGroup, AVideo.unitActor(15))
			//dark elf 1, 16 - Botin
			set createdUnit = CreateUnitAtRect(Game.hostilePlayer(), 'n01V', gg_rct_video_the_first_combat_dark_elf_1, 99.77)
			call GroupAddUnit(this.m_firstEnemyGroup, createdUnit)
			call AVideo.saveUnitActor(createdUnit)
			set createdUnit = null
			call GroupAddUnit(this.m_secondActorGroup, AVideo.unitActor(16))
			//dark elf 2, 17 - Satyr
			set createdUnit = CreateUnitAtRect(Game.hostilePlayer(), 'n02O', gg_rct_video_the_first_combat_dark_elf_2, 240.36)
			call GroupAddUnit(this.m_firstEnemyGroup, createdUnit)
			call AVideo.saveUnitActor(createdUnit)
			set createdUnit = null
			call GroupAddUnit(this.m_secondActorGroup, AVideo.unitActor(17))
			//dark elf 3, 18 - Waldgeist (weiblich)
			set createdUnit = CreateUnitAtRect(Game.hostilePlayer(), 'n01X', gg_rct_video_the_first_combat_dark_elf_3, 17.00)
			call GroupAddUnit(this.m_firstEnemyGroup, createdUnit)
			call AVideo.saveUnitActor(createdUnit)
			set createdUnit = null
