library StructMapMapSpawnPoints requires Asl, StructGameItemTypes, StructGameSpawnPoint
	...
	struct SpawnPoints
		...
		private static method init0 takes nothing returns nothing
			...
			call thistype.m_highwaymen0.addNewItemType(index, 'I00S', 0.50)
			call thistype.m_highwaymen0.addNewItemType(index, 'I00T', 0.50)
			call thistype.m_highwaymen0.addNewItemType(index, 'rhe2', 0.50)
			call thistype.m_highwaymen0.addNewItemType(index, 'rman', 0.50)
			call thistype.m_highwaymen0.addNewItemType(index, 'I049', 0.50)
			call thistype.m_highwaymen0.addNewItemType(index, 'I04D', 0.50)
			set index = thistype.m_highwaymen0.addUnitWithType(gg_unit_n00U_0128, 1.0)
			call thistype.m_highwaymen0.addNewItemType(index, 'I00S', 0.50)
			call thistype.m_highwaymen0.addNewItemType(index, 'I00T', 0.50)
			call thistype.m_highwaymen0.addNewItemType(index, 'I049', 0.50)
			call thistype.m_highwaymen0.addNewItemType(index, 'I04C', 0.50)
			call thistype.m_highwaymen0.addNewItemType(index, 'I04D', 0.50)
			...
			call thistype.m_highwaymen1.addNewItemType(index, 'I00S', 0.50)
			call thistype.m_highwaymen1.addNewItemType(index, 'I00T', 0.50)
			call thistype.m_highwaymen1.addNewItemType(index, 'I049', 0.50)
			call thistype.m_highwaymen1.addNewItemType(index, 'I04D', 0.50)
			set index = thistype.m_highwaymen1.addUnitWithType(gg_unit_n00U_0129, 1.0)
			call thistype.m_highwaymen1.addNewItemType(index, 'I00S', 0.50)
			call thistype.m_highwaymen1.addNewItemType(index, 'I00T', 0.50)
			call thistype.m_highwaymen1.addNewItemType(index, 'rhe2', 0.50)
			call thistype.m_highwaymen1.addNewItemType(index, 'rman', 0.50)
			call thistype.m_highwaymen1.addNewItemType(index, 'I049', 0.50)
			call thistype.m_highwaymen1.addNewItemType(index, 'I04D', 0.50)

			set thistype.m_highwaymen2 = SpawnPoint.create()
			set index = thistype.m_highwaymen2.addUnitWithType(gg_unit_n00T_0130, 1.0)
			call thistype.m_highwaymen2.addNewItemType(index, 'I00S', 0.50)
			call thistype.m_highwaymen2.addNewItemType(index, 'I00T', 0.50)
			call thistype.m_highwaymen2.addNewItemType(index, 'I049', 0.50)
			call thistype.m_highwaymen2.addNewItemType(index, 'I04D', 0.50)
			set index = thistype.m_highwaymen2.addUnitWithType(gg_unit_n00T_0131, 1.0)
			call thistype.m_highwaymen2.addNewItemType(index, 'I00S', 0.50)
			call thistype.m_highwaymen2.addNewItemType(index, 'I00T', 0.50)
			call thistype.m_highwaymen2.addNewItemType(index, 'rhe2', 0.50)
			call thistype.m_highwaymen2.addNewItemType(index, 'rman', 0.50)
			call thistype.m_highwaymen2.addNewItemType(index, 'I049', 0.50)
			call thistype.m_highwaymen2.addNewItemType(index, 'I04D', 0.50)
		...
		private static method init2 takes nothing returns nothing
			...
			call thistype.m_wildCreatures.addNewItemType(index, 'rhe2', 0.50)
			call thistype.m_wildCreatures.addNewItemType(index, 'I04O', 0.60)
		...
		private static method init3 takes nothing returns nothing
			...
			call thistype.m_cornEaters0.addNewItemType(index, 'whwd', 1.0)
			set thistype.m_cornEaters1 = SpawnPoint.create()
			set index = thistype.m_cornEaters1.addUnitWithType(gg_unit_n016_0473, 1.0)
			call thistype.m_cornEaters1.addNewItemType(index, 'whwd', 1.0)
