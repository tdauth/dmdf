library StructMapQuestsQuestDeathToBlackLegion requires Asl
	...
	struct QuestDeathToBlackLegion extends AQuest
		...
		private static method create takes ACharacter character returns thistype
			...
			//quest item 1
			set questItem1 = AQuestItem.create(this, tre("Töte so viele Krieger der schwarzen Legion wie möglich.", "Kill as many warriors of the Black Legion as possible."))
			// for 10 kills
