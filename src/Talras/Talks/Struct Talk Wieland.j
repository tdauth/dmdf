library StructMapTalksTalkWieland requires Asl, StructGameClasses, StructMapQuestsQuestTheKingsCrown, StructMapQuestsQuestWielandsSword
	...
	struct TalkWieland extends Talk
		...
		private static method info0_0Talk takes AInfo info, ACharacter character returns nothing
			...
			call speech(info, character, true, tre("Das war nur aus Zorn heraus als schlechter Scherz gemeint, aber ich will ihm zeigen, wie ernst es mir mit ihm ist.", "It was meant only out of anger as a bad joke, but I want to show him how serious I am about him."), gg_snd_Wieland7)
			call speech(info, character, true, tre("Die alten Sagen, die mir mein Vater erzählte, als ich noch selbst ein junger Bursche war, handelten oft von den Untoten. Wiederauferstandene Tote, die keinen Frieden finden konnten und nun alles töten wollen, was noch atmet.", "The old legends which my father told me when I was a young lad myself often were about undead. Resurrected dead who couldn't find peace and now wanted to kill everything still breathing."), gg_snd_Wieland8)
		...
		private static method infoAction3_0 takes AInfo info, ACharacter character returns nothing
			...
			call speech(info, character, true, tre("Also frag ihn nach einem besonders guten Schwert, der Preis sei dir egal, dann wird er es dir schon anbieten. Danach kommst du zu mir und sagst mir den Preis.", "So ask him for a particularly good sword, the price does not matter to you, then he'll offer it to you probably. Then you come to me and tell me the price."), gg_snd_Wieland32)
