...
// Trigger: Intro Play
//===========================================================================
function Trig_Intro_Play_Func003C takes nothing returns boolean
...
function Trig_Intro_Play_Func005C takes nothing returns boolean
    if ( not ( VideoWait(1.50) == true ) ) then
        return false
    endif
    return true
...
function Trig_Intro_Play_Func015C takes nothing returns boolean
    if ( not ( VideoWait(1.50) == true ) ) then
        return false
    endif
    return true
...
function Trig_Intro_Play_Actions takes nothing returns nothing
    ...
    call CameraSetupApplyForPlayer( true, gg_cam_intro_5, Player(0), 4.00 )
    call VideoFadeInWithWait(  )
    if ( Trig_Intro_Play_Func015C() ) then
        return
    else
    endif
